...
from routers.holdsRouter import router as holds_router
import uvicorn, os
...
app.mount("/reservations/static", StaticFiles(directory=static_dir), name="static")
...
app.include_router(holds_router, prefix="/reservations")
